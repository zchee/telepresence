...
func (r *Route) addStatic(ctx context.Context) error {
	return dexec.CommandContext(ctx, "ip", "route", "add", r.RoutedNet.String(), "via", r.LocalIP.String(), "dev", r.Interface.Name).Run()
}

func (r *Route) removeStatic(ctx context.Context) error {
	return dexec.CommandContext(ctx, "ip", "route", "del", r.RoutedNet.String(), "via", r.LocalIP.String(), "dev", r.Interface.Name).Run()
}
