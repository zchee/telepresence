...
// Source: github.com/telepresenceio/telepresence/v2/pkg/client/userd (interfaces: KubeConfigResolver)
...
func (m *MockKubeConfigResolver) NewKubeconfig(arg0 context.Context, arg1 map[string]string) (*client.Kubeconfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewKubeconfig", arg0, arg1)
	ret0, _ := ret[0].(*client.Kubeconfig)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockKubeConfigResolverMockRecorder) NewKubeconfig(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewKubeconfig", reflect.TypeOf((*MockKubeConfigResolver)(nil).NewKubeconfig), arg0, arg1)
}
